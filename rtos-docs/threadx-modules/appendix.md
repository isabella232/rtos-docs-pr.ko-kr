...
ms.locfileid: "116799373"
---
# <a name="appendix---port-specific-examples"></a>부록 - 포트 관련 예제

## <a name="arm11-processor"></a>ARM11 프로세서

### <a name="arm11-using-gcc"></a>GCC를 사용하는 ARM11

#### <a name="module-preamble-for-arm11-using-gcc"></a>GCC를 사용하는 ARM11의 모듈 머리말
...
#### <a name="module-properties-for-arm11-using-gcc"></a>GCC를 사용하는 ARM11의 모듈 속성

| bit | 값 | 의미 |
|---|---|---|
| [23-0] | 0 | 예약됨
| [31-24] | <br />0x00<br />0x01<br />0x02 | **컴파일러 ID**<br />IAR<br />ARM<br />GNU |

#### <a name="module-linker-for-arm11-using-gcc"></a>GCC를 사용하는 ARM11의 모듈 링커
...
#### <a name="building-modules-for-arm11-using-gcc"></a>GCC를 사용하는 ARM11의 모듈 빌드

GCC를 사용하여 ARM11 모듈을 빌드하는 간단한 명령줄 예제는 다음과 같습니다.
...
#### <a name="thread-extension-definition-for-arm11-using-gcc"></a>GCC를 사용하는 ARM11의 스레드 확장 정의
...
#### <a name="building-module-manager-for-arm11-using-gcc"></a>GCC를 사용하는 ARM11의 모듈 관리자 빌드

예제는 제공되지 않습니다.

#### <a name="attributes-for-external-memory-enable-api-for-arm11-using-gcc"></a>GCC를 사용하는 ARM11의 외부 메모리 사용 API에 대한 특성

이 기능은 이 포트에서 사용하도록 설정되지 않았습니다.

### <a name="arm11-using-ac5"></a>AC5를 사용하는 ARM11

#### <a name="module-preamble-for-arm11-using-ac5"></a>AC5를 사용하는 ARM11의 모듈 머리말
...
#### <a name="module-properties-for-arm11-using-ac5"></a>AC5를 사용하는 ARM11의 모듈 속성
...
#### <a name="module-linker-for-arm11-using-ac5"></a>AC5를 사용하는 ARM11의 모듈 링커

명령줄을 기반으로 하며 링커 파일 예제는 없습니다.

#### <a name="building-modules-for-arm11-using-ac5"></a>AC5를 사용하는 ARM11의 모듈 빌드

AC5를 사용하여 ARM11 모듈을 빌드하는 간단한 명령줄 예제는 다음과 같습니다.
...
#### <a name="thread-extension-definition-for-arm11-using-ac5"></a>AC5를 사용하는 ARM11의 스레드 확장 정의
...
#### <a name="building-module-manager-for-arm11-using-ac5"></a>AC5를 사용하는 ARM11의 모듈 관리자 빌드

AC5를 사용하여 ARM11 모듈 관리자를 빌드하는 간단한 명령줄 예제는 다음과 같습니다.
...
#### <a name="attributes-for-external-memory-enable-api-for-arm11-using-ac5"></a>AC5를 사용하는 ARM11의 외부 메모리 사용 API에 대한 특성

이 기능은 이 포트에서 사용하도록 설정되지 않았습니다.

## <a name="cortex-a7-processor"></a>Cortex-A7 프로세서

### <a name="cortex-a7-using-ac5"></a>AC5를 사용하는 Cortex-A7

#### <a name="module-preamble-for-cortex-a7-using-ac5"></a>AC5를 사용하는 Cortex-A7의 모듈 머리말
...
#### <a name="module-properties-for-cortex-a7-using-ac5"></a>AC5를 사용하는 Cortex-A7의 모듈 속성
...
#### <a name="module-linker-for-cortex-a7-using-ac5"></a>AC5를 사용하는 Cortex-A7의 모듈 링커

명령줄을 기반으로 하며 링커 파일 예제는 없습니다.

#### <a name="building-modules-for-cortex-a7-using-ac5"></a>AC5를 사용하는 Cortex-A7의 모듈 빌드

AC5를 사용하여 Cortex-A7 모듈을 빌드하는 간단한 명령줄 예제는 다음과 같습니다.
...
#### <a name="thread-extension-definition-for-cortex-a7-using-ac5"></a>AC5를 사용하는 Cortex-A7의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-a7-using-ac5"></a>AC5를 사용하는 Cortex-A7의 모듈 관리자 빌드

AC5를 사용하여 Cortex-A7 모듈 관리자를 빌드하는 간단한 명령줄 예제는 다음과 같습니다.
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-a7-using-ac5"></a>AC5를 사용하는 Cortex-A7의 외부 메모리 사용 API에 대한 특성

다음 특성을 사용하여 공유 메모리 설정을 지정할 수 있습니다.

| 특성 매개 변수 | 의미 |
|---|---|
| TXM_MMU_ATTRIBUTE_XN | 실행 안 함 |
| TXM_MMU_ATTRIBUTE_B | B 설정 |
| TXM_MMU_ATTRIBUTE_C | C 설정 |
| TXM_MMU_ATTRIBUTE_AP | AP 설정 |
| TXM_MMU_ATTRIBUTE_TEX | TEX 설정 |

이러한 설정을 구성하는 방법은 ARM 설명서를 참조하십시오.

## <a name="cortex-m3-processor"></a>Cortex-M3 프로세서

### <a name="cortex-m3-using-ac5"></a>AC5를 사용하는 Cortex-M3

#### <a name="module-preamble-for-cortex-m3-using-ac5"></a>AC5를 사용하는 Cortex-M3의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m3-using-ac5"></a>AC5를 사용하는 Cortex-M3의 모듈 속성
...
#### <a name="module-linker-for-cortex-m3-using-ac5"></a>AC5를 사용하는 Cortex-M3의 모듈 링커

예제 링커 파일은 제공되지 않으며 명령줄에서 링크가 수행됩니다. 다음 섹션을 참조하십시오.

#### <a name="building-modules-for-cortex-m3-using-ac5"></a>AC5를 사용하는 Cortex-M3의 모듈 빌드
...
#### <a name="thread-extension-definition-for-cortex-m3-using-ac5"></a>AC5를 사용하는 Cortex-M3의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m3-using-ac5"></a>AC5를 사용하는 Cortex-M3의 모듈 관리자 빌드

build_threadx_module_manager_demo.bat 예제를 참조하십시오.
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-ac5"></a>AC5를 사용하는 Cortex-M3의 외부 메모리 사용 API에 대한 특성

모듈에는 항상 공유 메모리에 대한 읽기 권한이 있습니다.

| 특성 매개 변수 | 의미 |
|---|---|
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_WRITE | 쓰기 액세스 |

### <a name="cortex-m3-using-ac6"></a>AC6을 사용하는 Cortex-M3

#### <a name="module-preamble-for-cortex-m3-using-ac6"></a>AC6을 사용하는 Cortex-M3의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m3-using-ac6"></a>AC6을 사용하는 Cortex-M3의 모듈 속성
...
#### <a name="module-linker-for-cortex-m3-using-ac6"></a>AC6을 사용하는 Cortex-M3의 모듈 링커

링커 파일이 사용되지 않습니다. 프로젝트 설정을 참조하십시오.

#### <a name="building-modules-for-cortex-m3-using-ac6"></a>AC6을 사용하는 Cortex-M3의 모듈 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 샘플 모듈 프로젝트 및 샘플 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="thread-extension-definition-for-cortex-m3-using-ac6"></a>AC6을 사용하는 Cortex-M3의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m3-using-ac6"></a>AC6을 사용하는 Cortex-M3의 모듈 관리자 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 샘플 모듈 프로젝트 및 샘플 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-ac6"></a>AC6을 사용하는 Cortex-M3의 외부 메모리 사용 API에 대한 특성
...
### <a name="cortex-m3-using-gnu"></a>GNU를 사용하는 Cortex-M3

#### <a name="module-preamble-for-cortex-m3-using-gnu"></a>GNU를 사용하는 Cortex-M3의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m3-using-gnu"></a>GNU를 사용하는 Cortex-M3의 모듈 속성
...
#### <a name="module-linker-for-cortex-m3-using-gnu"></a>GNU를 사용하는 Cortex-M3의 모듈 링커
...
#### <a name="building-modules-for-cortex-m3-using-gnu"></a>GNU를 사용하는 Cortex-M3의 모듈 빌드

build_threadx_module_sample.bat를 참조하십시오.
...
#### <a name="thread-extension-definition-for-cortex-m3-using-gnu"></a>GNU를 사용하는 Cortex-M3의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m3-using-gnu"></a>GNU를 사용하는 Cortex-M3의 모듈 관리자 빌드

build_threadx_module_manager_sample.bat를 참조하십시오.
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-gnu"></a>GNU를 사용하는 Cortex-M3의 외부 메모리 사용 API에 대한 특성
...
### <a name="cortex-m3-using-iar"></a>IAR을 사용하는 Cortex-M3

#### <a name="module-preamble-for-cortex-m3-using-iar"></a>IAR을 사용하는 Cortex-M3의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m3-using-iar"></a>IAR을 사용하는 Cortex-M3의 모듈 속성
...
#### <a name="module-linker-for-cortex-m3-using-iar"></a>IAR을 사용하는 Cortex-M3의 모듈 링커
...
#### <a name="building-modules-for-cortex-m3-using-iar"></a>IAR을 사용하는 Cortex-M3의 모듈 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="thread-extension-definition-for-cortex-m3-using-iar"></a>IAR을 사용하는 Cortex-M3의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m3-using-iar"></a>IAR을 사용하는 Cortex-M3의 모듈 관리자 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-iar"></a>IAR을 사용하는 Cortex-M3의 외부 메모리 사용 API에 대한 특성
...
## <a name="cortex-m33-processor"></a>Cortex-M33 프로세서

### <a name="cortex-m33-using-ac6"></a>AC6을 사용하는 Cortex-M33

#### <a name="module-preamble-for-cortex-m33-using-ac6"></a>AC6을 사용하는 Cortex-M33의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m33-using-ac6"></a>AC6을 사용하는 Cortex-M33의 모듈 속성
...
#### <a name="module-linker-for-cortex-m33-using-ac6"></a>AC6을 사용하는 Cortex-M33의 모듈 링커

Keil 도구 체인에는 링커 파일이 필요하지 않습니다. 예제 프로젝트의 빌드 설정을 참조하십시오.
중요한 링커 옵션은 아래와 같습니다.
...
#### <a name="building-modules-for-cortex-m33-using-ac6"></a>AC6을 사용하는 Cortex-M33의 모듈 빌드
...
#### <a name="thread-extension-definition-for-cortex-m33-using-ac6"></a>AC6을 사용하는 Cortex-M33의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m33-using-ac6"></a>AC6을 사용하는 Cortex-M33의 모듈 관리자 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, sample_threadx_module 프로젝트 및 demo_threadx_non-secure_zone 프로젝트를 빌드합니다.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-ac6"></a>AC6을 사용하는 Cortex-M33의 외부 메모리 사용 API에 대한 특성
...
### <a name="cortex-m33-using-gnu"></a>GNU를 사용하는 Cortex-M33

#### <a name="module-preamble-for-cortex-m33-using-gnu"></a>GNU를 사용하는 Cortex-M33의 모듈 머리말

#### <a name="module-properties-for-cortex-m33-using-gnu"></a>GNU를 사용하는 Cortex-M33의 모듈 속성
...
#### <a name="module-linker-for-cortex-m33-using-gnu"></a>GNU를 사용하는 Cortex-M33의 모듈 링커

#### <a name="building-modules-for-cortex-m33-using-gnu"></a>GNU를 사용하는 Cortex-M33의 모듈 빌드

#### <a name="thread-extension-definition-for-cortex-m33-using-gnu"></a>GNU를 사용하는 Cortex-M33의 스레드 확장 정의

#### <a name="building-module-manager-for-cortex-m33-using-gnu"></a>GNU를 사용하는 Cortex-M33의 모듈 관리자 빌드

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-gnu"></a>GNU를 사용하는 Cortex-M33의 외부 메모리 사용 API에 대한 특성
...
### <a name="cortex-m33-using-iar"></a>IAR을 사용하는 Cortex-M33

#### <a name="module-preamble-for-cortex-m33-using-iar"></a>IAR을 사용하는 Cortex-M33의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m33-using-iar"></a>IAR을 사용하는 Cortex-M33의 모듈 속성
...
#### <a name="module-linker-for-cortex-m33-using-iar"></a>IAR을 사용하는 Cortex-M33의 모듈 링커
...
#### <a name="building-modules-for-cortex-m33-using-iar"></a>IAR을 사용하는 Cortex-M33의 모듈 빌드

#### <a name="thread-extension-definition-for-cortex-m33-using-iar"></a>IAR을 사용하는 Cortex-M33의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m33-using-iar"></a>IAR을 사용하는 Cortex-M33의 모듈 관리자 빌드

예제 작업 영역이 아직 제공되지 않았습니다. 곧 제공될 예정입니다.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-iar"></a>IAR을 사용하는 Cortex-M33의 외부 메모리 사용 API에 대한 특성
...
## <a name="cortex-m4-processor"></a>Cortex-M4 프로세서

### <a name="cortex-m4-using-ac5"></a>AC5를 사용하는 Cortex-M4

#### <a name="module-preamble-for-cortex-m4-using-ac5"></a>AC5를 사용하는 Cortex-M4의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m4-using-ac5"></a>AC5를 사용하는 Cortex-M4의 모듈 속성
...
#### <a name="module-linker-for-cortex-m4-using-ac5"></a>AC5를 사용하는 Cortex-M4의 모듈 링커

예제 링커 파일은 제공되지 않으며 명령줄에서 링크가 수행됩니다. 다음 섹션을 참조하십시오.

#### <a name="building-modules-for-cortex-m4-using-ac5"></a>AC5를 사용하는 Cortex-M4의 모듈 빌드

build_threadx_module_demo.bat 예제를 참조하십시오.
...
#### <a name="thread-extension-definition-for-cortex-m4-using-ac5"></a>AC5를 사용하는 Cortex-M4의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m4-using-ac5"></a>AC5를 사용하는 Cortex-M4의 모듈 관리자 빌드
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-ac5"></a>AC5를 사용하는 Cortex-M4의 외부 메모리 사용 API에 대한 특성
...
### <a name="cortex-m4-using-ac6"></a>AC6을 사용하는 Cortex-M4

#### <a name="module-preamble-for-cortex-m4-using-ac6"></a>AC6을 사용하는 Cortex-M4의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m4-using-ac6"></a>AC6을 사용하는 Cortex-M4의 모듈 속성
...
#### <a name="module-linker-for-cortex-m4-using-ac6"></a>AC6을 사용하는 Cortex-M4의 모듈 링커

링커 파일이 사용되지 않습니다. 프로젝트 설정을 참조하십시오.

#### <a name="building-modules-for-cortex-m4-using-ac6"></a>AC6을 사용하는 Cortex-M4의 모듈 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 샘플 모듈 프로젝트 및 샘플 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="thread-extension-definition-for-cortex-m4-using-ac6"></a>AC6을 사용하는 Cortex-M4의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m4-using-ac6"></a>AC6을 사용하는 Cortex-M4의 모듈 관리자 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 샘플 모듈 프로젝트 및 샘플 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-ac6"></a>AC6을 사용하는 Cortex-M4의 외부 메모리 사용 API에 대한 특성
...
### <a name="cortex-m4-using-gnu"></a>GNU를 사용하는 Cortex-M4

#### <a name="module-preamble-for-cortex-m4-using-gnu"></a>GNU를 사용하는 Cortex-M4의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m4-using-gnu"></a>GNU를 사용하는 Cortex-M4의 모듈 속성
...
#### <a name="module-linker-for-cortex-m4-using-gnu"></a>GNU를 사용하는 Cortex-M4의 모듈 링커
...
#### <a name="building-modules-for-cortex-m4-using-gnu"></a>GNU를 사용하는 Cortex-M4의 모듈 빌드
...
#### <a name="thread-extension-definition-for-cortex-m4-using-gnu"></a>GNU를 사용하는 Cortex-M4의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m4-using-gnu"></a>GNU를 사용하는 Cortex-M4의 모듈 관리자 빌드
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-gnu"></a>GNU를 사용하는 Cortex-M4의 외부 메모리 사용 API에 대한 특성
...
### <a name="cortex-m4-using-iar"></a>IAR을 사용하는 Cortex-M4

#### <a name="module-preamble-for-cortex-m4-using-iar"></a>IAR을 사용하는 Cortex-M4의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m4-using-iar"></a>IAR을 사용하는 Cortex-M4의 모듈 속성
...
#### <a name="module-linker-for-cortex-m4-using-iar"></a>IAR을 사용하는 Cortex-M4의 모듈 링커
...
#### <a name="building-modules-for-cortex-m4-using-iar"></a>IAR을 사용하는 Cortex-M4의 모듈 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="thread-extension-definition-for-cortex-m4-using-iar"></a>IAR을 사용하는 Cortex-M4의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m4-using-iar"></a>IAR을 사용하는 Cortex-M4의 모듈 관리자 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-iar"></a>IAR을 사용하는 Cortex-M4의 외부 메모리 사용 API에 대한 특성
...
## <a name="cortex-m7-processor"></a>Cortex-M7 프로세서

### <a name="cortex-m7-using-ac5"></a>AC5를 사용하는 Cortex-M7

#### <a name="module-preamble-for-cortex-m7-using-ac5"></a>AC5를 사용하는 Cortex-M7의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m7-using-ac5"></a>AC5를 사용하는 Cortex-M7의 모듈 속성
...
#### <a name="module-linker-for-cortex-m7-using-ac5"></a>AC5를 사용하는 Cortex-M7의 모듈 링커

명령줄을 기반으로 하며 링커 파일 예제는 없습니다.

#### <a name="building-modules-for-cortex-m7-using-ac5"></a>AC5를 사용하는 Cortex-M7의 모듈 빌드

AC5를 사용하여 Cortex-M7 모듈을 빌드하는 간단한 명령줄 예제는 다음과 같습니다.
...
#### <a name="thread-extension-definition-for-cortex-m7-using-ac5"></a>AC5를 사용하는 Cortex-M7의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m7-using-ac5"></a>AC5를 사용하는 Cortex-M7의 모듈 관리자 빌드

AC5를 사용하여 Cortex-M7 모듈 관리자를 빌드하는 간단한 명령줄 예제는 다음과 같습니다.
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-ac5"></a>AC5를 사용하는 Cortex-M7의 외부 메모리 사용 API에 대한 특성

### <a name="cortex-m7-using-ac6"></a>AC6을 사용하는 Cortex-M7

#### <a name="module-properties-for-cortex-m7-using-ac6"></a>AC6을 사용하는 Cortex-M7의 모듈 속성
...
#### <a name="module-linker-for-cortex-m7-using-ac6"></a>AC6을 사용하는 Cortex-M7의 모듈 링커

링커 파일이 사용되지 않습니다. 프로젝트 설정을 참조하십시오.

#### <a name="building-modules-for-cortex-m7-using-ac6"></a>AC6을 사용하는 Cortex-M7의 모듈 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 샘플 모듈 프로젝트 및 샘플 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="thread-extension-definition-for-cortex-m7-using-ac6"></a>AC6을 사용하는 Cortex-M7의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m7-using-ac6"></a>AC6을 사용하는 Cortex-M7의 모듈 관리자 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 샘플 모듈 프로젝트 및 샘플 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-ac6"></a>AC6을 사용하는 Cortex-M7의 외부 메모리 사용 API에 대한 특성
...
### <a name="cortex-m7-using-gnu"></a>GNU를 사용하는 Cortex-M7

#### <a name="module-properties-for-cortex-m7-using-gnu"></a>GNU를 사용하는 Cortex-M7의 모듈 속성
...
#### <a name="module-linker-for-cortex-m7-using-gnu"></a>GNU를 사용하는 Cortex-M7의 모듈 링커
...
#### <a name="building-modules-for-cortex-m7-using-gnu"></a>GNU를 사용하는 Cortex-M7의 모듈 빌드
...
#### <a name="thread-extension-definition-for-cortex-m7-using-gnu"></a>GNU를 사용하는 Cortex-M7의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m7-using-gnu"></a>GNU를 사용하는 Cortex-M7의 모듈 관리자 빌드
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-gnu"></a>GNU를 사용하는 Cortex-M7의 외부 메모리 사용 API에 대한 특성
...
### <a name="cortex-m7-using-iar"></a>IAR을 사용하는 Cortex-M7

#### <a name="module-preamble-for-cortex-m7-using-iar"></a>IAR을 사용하는 Cortex-M7의 모듈 머리말
...
#### <a name="module-properties-for-cortex-m7-using-iar"></a>IAR을 사용하는 Cortex-M7의 모듈 속성
...
#### <a name="module-linker-for-cortex-m7-using-iar"></a>IAR을 사용하는 Cortex-M7의 모듈 링커
...
#### <a name="building-modules-for-cortex-m7-using-iar"></a>IAR을 사용하는 Cortex-M7의 모듈 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="thread-extension-definition-for-cortex-m7-using-iar"></a>IAR을 사용하는 Cortex-M7의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-m7-using-iar"></a>IAR을 사용하는 Cortex-M7의 모듈 관리자 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-iar"></a>IAR을 사용하는 Cortex-M7의 외부 메모리 사용 API에 대한 특성
...
## <a name="cortex-r4-processor"></a>Cortex-R4 프로세서

### <a name="cortex-r4-using-ac6"></a>AC6을 사용하는 Cortex-R4

#### <a name="module-preamble-for-cortex-r4-using-ac6"></a>AC6을 사용하는 Cortex-R4의 모듈 머리말
...
#### <a name="module-properties-for-cortex-r4-using-ac6"></a>AC6을 사용하는 Cortex-R4의 모듈 속성
...
#### <a name="module-linker-for-cortex-r4-using-ac6"></a>AC6을 사용하는 Cortex-R4의 모듈 링커

명령줄을 기반으로 하며 링커 파일 예제는 없습니다.

#### <a name="building-modules-for-cortex-r4-using-ac6"></a>AC6을 사용하는 Cortex-R4의 모듈 빌드

AC6을 사용하여 Cortex-R4 모듈을 빌드하는 간단한 명령줄 예제는 다음과 같습니다.
...
#### <a name="thread-extension-definition-for-cortex-r4-using-ac6"></a>AC6을 사용하는 Cortex-R4의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-r4-using-ac6"></a>AC6을 사용하는 Cortex-R4의 모듈 관리자 빌드

AC6을 사용하여 Cortex-R4 모듈 관리자를 빌드하는 간단한 명령줄 예제는 다음과 같습니다.
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-r4-using-ac6"></a>AC6을 사용하는 Cortex-R4의 외부 메모리 사용 API에 대한 특성
...
### <a name="cortex-r4-using-iar"></a>IAR을 사용하는 Cortex-R4

#### <a name="module-preamble-for-cortex-r4-using-iar"></a>IAR을 사용하는 Cortex-R4의 모듈 머리말
...
#### <a name="module-properties-for-cortex-r4-using-iar"></a>IAR을 사용하는 Cortex-R4의 모듈 속성
...
#### <a name="module-linker-for-cortex-r4-using-iar"></a>IAR을 사용하는 Cortex-R4의 모듈 링커
...
#### <a name="building-modules-for-cortex-r4-using-iar"></a>IAR을 사용하는 Cortex-R4의 모듈 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="thread-extension-definition-for-cortex-r4-using-iar"></a>IAR을 사용하는 Cortex-R4의 스레드 확장 정의
...
#### <a name="building-module-manager-for-cortex-r4-using-iar"></a>IAR을 사용하는 Cortex-R4의 모듈 관리자 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-r4-using-iar"></a>IAR을 사용하는 Cortex-R4의 외부 메모리 사용 API에 대한 특성
...
## <a name="mcf544xx-processor"></a>MCF544xx 프로세서

### <a name="mcf544xx-using-ghs"></a>GHS를 사용하는 MCF544xx

#### <a name="module-preamble-for-mcf544xx-using-ghs"></a>GHS를 사용하는 MCF544xx의 모듈 머리말
...
#### <a name="module-properties-for-mcf544xx-using-ghs"></a>GHS를 사용하는 MCF544xx의 모듈 속성

| bit | 값 | 의미 |
|---|---|---|
| 0 | 0<br />1 | 권한 있는 모드 실행<br />사용자 모드 실행 |
| 1 | 0<br />1 | MMU 보호 없음<br />MMU 보호(사용자 모드가 선택되어 있어야 함) |
| 2 | 0<br />1 | 공유/외부 메모리 액세스 사용 안 함<br />공유/외부 메모리 액세스 사용 |
| [23-3] | 0 | 예약됨
| [31-24] | <br />0x03 | **컴파일러 ID**<br />GHS |

#### <a name="module-linker-for-mcf544xx-using-ghs"></a>GHS를 사용하는 MCF544xx의 모듈 링커
...
#### <a name="building-modules-for-mcf544xx-using-ghs"></a>GHS를 사용하는 MCF544xx의 모듈 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="thread-extension-definition-for-mcf544xx-using-ghs"></a>GHS를 사용하는 MCF544xx의 스레드 확장 정의
...
#### <a name="building-module-manager-for-mcf544xx-using-ghs"></a>GHS를 사용하는 MCF544xx의 모듈 관리자 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="attributes-for-external-memory-enable-api-for-mcf544xx-using-ghs"></a>GHS를 사용하는 MCF544xx의 외부 메모리 사용 API에 대한 특성

이 기능은 MCF544xx에서 사용하도록 설정되지 않았습니다.

## <a name="rx63-processor"></a>RX63 프로세서

### <a name="rx63-using-iar"></a>IAR을 사용하는 RX63

#### <a name="module-preamble-for-rx63-using-iar"></a>IAR을 사용하는 RX63의 모듈 머리말
...
#### <a name="module-properties-for-rx63-using-iar"></a>IAR을 사용하는 RX63의 모듈 속성
...
| 2 | 0<br />1 | 공유/외부 메모리 액세스 사용 안 함<br />공유/외부 메모리 액세스 사용 |
| [23-3] | 0 | 예약됨
| [31-24] | <br />0x00<br />0x02 | **컴파일러 ID**<br />IAR<br />GNU |

#### <a name="module-linker-for-rx63-using-iar"></a>IAR을 사용하는 RX63의 모듈 링커
...
#### <a name="building-modules-for-rx63-using-iar"></a>IAR을 사용하는 RX63의 모듈 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="thread-extension-definition-for-rxrx635n-using-iar"></a>IAR을 사용하는 RXRX635N의 스레드 확장 정의
...
#### <a name="building-module-manager-for-rx63-using-iar"></a>IAR을 사용하는 RX63의 모듈 관리자 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="attributes-for-external-memory-enable-api-for-rx63-using-iar"></a>IAR을 사용하는 RX63의 외부 메모리 사용 API에 대한 특성

| 특성 매개 변수 | 의미 |
|---|---|
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_EXECUTE | 코드 실행 |
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_WRITE | 쓰기 액세스 |
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_READ | 읽기 액세스 |

## <a name="rx65n-processor"></a>RX65N 프로세서

### <a name="rx65n-using-iar"></a>IAR을 사용하는 RX65N

#### <a name="module-preamble-for-rx65n-using-iar"></a>IAR을 사용하는 RX65N의 모듈 머리말
...
#### <a name="module-properties-for-rx65n-using-iar"></a>IAR을 사용하는 RX65N의 모듈 속성
...
#### <a name="module-linker-for-rx65n-using-iar"></a>IAR을 사용하는 RX65N의 모듈 링커
...
#### <a name="building-modules-for-rx65n-using-iar"></a>IAR을 사용하는 RX65N의 모듈 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="thread-extension-definition-for-rx65n-using-iar"></a>IAR을 사용하는 RX65N의 스레드 확장 정의
...
#### <a name="building-module-manager-for-rx65n-using-iar"></a>IAR을 사용하는 RX65N의 모듈 관리자 빌드

예제 작업 영역이 제공됩니다. ThreadX 라이브러리, ThreadX 모듈 라이브러리, 데모 모듈 프로젝트 및 데모 모듈 관리자 프로젝트를 빌드합니다.

#### <a name="attributes-for-external-memory-enable-api-for-rx65n-using-iar"></a>IAR을 사용하는 RX65N의 외부 메모리 사용 API에 대한 특성
