...
---
# <a name="guix-example"></a>GUIX 예제

GUIX 시연 시스템은 examples/helloworld/helloworld.c에 정의된 작은 예제에서 제공됩니다. 이 예제에서는 GUIX 시스템을 초기화하고 디스플레이 드라이버를 설정하는 데 필요한 단계를 보여줍니다. 소스 코드는 다음 페이지에 나열되어 있습니다.
