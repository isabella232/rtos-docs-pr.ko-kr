---
title: GUIX 예제
description: GUIX 시연 시스템은 examples/helloworld/helloworld.c에 정의된 작은 예제에서 제공됩니다.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104811155"
---
# <a name="guix-example"></a><span data-ttu-id="be96e-103">GUIX 예제</span><span class="sxs-lookup"><span data-stu-id="be96e-103">GUIX Example</span></span>

<span data-ttu-id="be96e-104">GUIX 시연 시스템은 examples/helloworld/helloworld.c에 정의된 작은 예제에서 제공됩니다.</span><span class="sxs-lookup"><span data-stu-id="be96e-104">The GUIX demonstration system is delivered with a small example, defined in examples/helloworld/helloworld.c.</span></span> <span data-ttu-id="be96e-105">이 예제에서는 GUIX 시스템을 초기화하고 디스플레이 드라이버를 설정하는 데 필요한 단계를 보여줍니다.</span><span class="sxs-lookup"><span data-stu-id="be96e-105">This example illustrates the steps needed to take to initialize the GUIX system, to set up display drivers.</span></span> <span data-ttu-id="be96e-106">소스 코드는 다음 페이지에 나열되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="be96e-106">The source code is listed on the following pages.</span></span>
