...
---
# <a name="appendix-b---azure-rtos-threadx-smp-constants"></a>부록 B - Azure RTOS ThreadX SMP 상수

## <a name="alphabetic-listings"></a>사전순 목록
...
0xFFFFFFFFUL
```
## <a name="listing-by-value"></a>값으로 나열
