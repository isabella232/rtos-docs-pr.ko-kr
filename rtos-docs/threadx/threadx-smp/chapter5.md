...
외부 환경과의 통신은 대부분의 임베디드 애플리케이션의 중요한 구성 요소입니다. 이 통신은 포함된 애플리케이션 소프트웨어에 액세스할 수 있는 하드웨어 디바이스를 통해 수행됩니다. 이러한 디바이스를 관리하는 소프트웨어 구성 요소를 일반적으로 *디바이스 드라이버* 라고 합니다.
