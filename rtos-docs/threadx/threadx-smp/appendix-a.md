...
---
# <a name="appendix-a---azure-rtos-threadx-smp-api-services"></a>부록 A - Azure RTOS ThreadX SMP API 서비스

## <a name="entry-function"></a>Entry 함수

```C
VOID     tx_kernel_enter(VOID);
```
## <a name="block-memory-services"></a>메모리 서비스 차단
...
```
## <a name="byte-memory-services"></a>바이트 메모리 서비스
...
```
## <a name="event-flags-services"></a>이벤트 플래그 서비스
...
```
## <a name="mutex-services"></a>뮤텍스 서비스
...
```
## <a name="semaphore-services"></a>세마포 서비스
...
UINT     tx_semaphore_put_notify(TX_SEMAPHORE
            ...
            *));
```
## <a name="thread-control-services"></a>스레드 제어 서비스
...
```
## <a name="time-services"></a>시간 서비스

```C
ULONG     tx_time_get(VOID);
VOID      tx_time_set(ULONG new_time);
```
## <a name="timer-services"></a>타이머 서비스
