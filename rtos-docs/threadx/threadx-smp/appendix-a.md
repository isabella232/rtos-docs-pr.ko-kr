---
title: 부록 A - Azure RTOS ThreadX SMP API 서비스
description: ThreadX SMP API 서비스
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104812157"
---
# <a name="appendix-a---azure-rtos-threadx-smp-api-services"></a><span data-ttu-id="2f0a7-103">부록 A - Azure RTOS ThreadX SMP API 서비스</span><span class="sxs-lookup"><span data-stu-id="2f0a7-103">Appendix A - Azure RTOS ThreadX SMP API Services</span></span>

## <a name="entry-function"></a><span data-ttu-id="2f0a7-104">Entry 함수</span><span class="sxs-lookup"><span data-stu-id="2f0a7-104">Entry Function</span></span>

```C
VOID     tx_kernel_enter(VOID);
```
## <a name="block-memory-services"></a><span data-ttu-id="2f0a7-105">메모리 서비스 차단</span><span class="sxs-lookup"><span data-stu-id="2f0a7-105">Block Memory Services</span></span>
...
```
## <a name="byte-memory-services"></a><span data-ttu-id="2f0a7-106">바이트 메모리 서비스</span><span class="sxs-lookup"><span data-stu-id="2f0a7-106">Byte Memory Services</span></span>
...
```
## <a name="event-flags-services"></a><span data-ttu-id="2f0a7-107">이벤트 플래그 서비스</span><span class="sxs-lookup"><span data-stu-id="2f0a7-107">Event Flags Services</span></span>
...
UINT     tx_event_flags_set_notify(TX_EVENT_FLAGS_GROUP
            ...
            *));
```
## <a name="interrupt-control"></a><span data-ttu-id="2f0a7-108">인터럽트 제어</span><span class="sxs-lookup"><span data-stu-id="2f0a7-108">Interrupt Control</span></span>

```C
UINT     tx_interrupt_control(UINT new_posture);
```
## <a name="mutex-services"></a><span data-ttu-id="2f0a7-109">뮤텍스 서비스</span><span class="sxs-lookup"><span data-stu-id="2f0a7-109">Mutex Services</span></span>
...
```
## <a name="queue-services"></a><span data-ttu-id="2f0a7-110">큐 서비스</span><span class="sxs-lookup"><span data-stu-id="2f0a7-110">Queue Services</span></span>
...
```
## <a name="semaphore-services"></a><span data-ttu-id="2f0a7-111">세마포 서비스</span><span class="sxs-lookup"><span data-stu-id="2f0a7-111">Semaphore Services</span></span>
...
UINT     tx_semaphore_put_notify(TX_SEMAPHORE
            ...
            *));
```
## <a name="thread-control-services"></a><span data-ttu-id="2f0a7-112">스레드 제어 서비스</span><span class="sxs-lookup"><span data-stu-id="2f0a7-112">Thread Control Services</span></span>
...
```
## <a name="time-services"></a><span data-ttu-id="2f0a7-113">시간 서비스</span><span class="sxs-lookup"><span data-stu-id="2f0a7-113">Time Services</span></span>

```C
ULONG     tx_time_get(VOID);
VOID      tx_time_set(ULONG new_time);
```
## <a name="timer-services"></a><span data-ttu-id="2f0a7-114">타이머 서비스</span><span class="sxs-lookup"><span data-stu-id="2f0a7-114">Timer Services</span></span>
