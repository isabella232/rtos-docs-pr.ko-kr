---
title: 부록 C - Azure RTOS ThreadX SMP 데이터 형식
description: ThreadX SMP 데이터 형식
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104812151"
---
# <a name="appendix-c---azure-rtos-threadx-smp-data-types"></a><span data-ttu-id="09f3d-103">부록 C - Azure RTOS ThreadX SMP 데이터 형식</span><span class="sxs-lookup"><span data-stu-id="09f3d-103">Appendix C - Azure RTOS ThreadX SMP Data Types</span></span>

## <a name="tx_block_pool"></a><span data-ttu-id="09f3d-104">TX_BLOCK_POOL</span><span class="sxs-lookup"><span data-stu-id="09f3d-104">TX_BLOCK_POOL</span></span>
...
```
## <a name="tx_byte_pool"></a><span data-ttu-id="09f3d-105">TX_BYTE_POOL</span><span class="sxs-lookup"><span data-stu-id="09f3d-105">TX_BYTE_POOL</span></span>
...
```
## <a name="tx_event_flags_group"></a><span data-ttu-id="09f3d-106">TX_EVENT_FLAGS_GROUP</span><span class="sxs-lookup"><span data-stu-id="09f3d-106">TX_EVENT_FLAGS_GROUP</span></span>
...
```
## <a name="tx_mutex"></a><span data-ttu-id="09f3d-107">TX_MUTEX</span><span class="sxs-lookup"><span data-stu-id="09f3d-107">TX_MUTEX</span></span>
...
## <a name="tx_queue"></a><span data-ttu-id="09f3d-108">TX_QUEUE</span><span class="sxs-lookup"><span data-stu-id="09f3d-108">TX_QUEUE</span></span>
...
```
## <a name="tx_semaphore"></a><span data-ttu-id="09f3d-109">TX_SEMAPHORE</span><span class="sxs-lookup"><span data-stu-id="09f3d-109">TX_SEMAPHORE</span></span>
...
```
## <a name="tx_thread"></a><span data-ttu-id="09f3d-110">TX_THREAD</span><span class="sxs-lookup"><span data-stu-id="09f3d-110">TX_THREAD</span></span>
...
```
## <a name="tx_timer"></a><span data-ttu-id="09f3d-111">TX_TIMER</span><span class="sxs-lookup"><span data-stu-id="09f3d-111">TX_TIMER</span></span>
...
## <a name="tx_timer_internal"></a><span data-ttu-id="09f3d-112">TX_TIMER_INTERNAL</span><span class="sxs-lookup"><span data-stu-id="09f3d-112">TX_TIMER_INTERNAL</span></span>
