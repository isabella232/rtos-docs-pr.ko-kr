---
title: 부록 A - 샘플 tx_port.h
description: 이 장에서는 샘플 tx_port.h 파일을 표시합니다.
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104812666"
---
# <a name="appendix-a---sample-tx_porth"></a><span data-ttu-id="139fd-103">부록 A - 샘플 tx_port.h</span><span class="sxs-lookup"><span data-stu-id="139fd-103">Appendix A - Sample tx_port.h</span></span>

<span data-ttu-id="139fd-104">이 장에서는 샘플 **tx_port.h** 파일을 표시합니다.</span><span class="sxs-lookup"><span data-stu-id="139fd-104">This chapter displays a sample **tx_port.h** file.</span></span>
