---
title: 부록 B - tx_trace.h 파일
description: 이 장에서는 tx_trace.h 파일을 표시합니다.
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104812643"
---
# <a name="appendix-b---the-tx_traceh-file"></a><span data-ttu-id="ec5f1-103">부록 B - tx_trace.h 파일</span><span class="sxs-lookup"><span data-stu-id="ec5f1-103">Appendix B - The tx_trace.h file</span></span>

<span data-ttu-id="ec5f1-104">이 장에서는 **tx_trace.h** 파일을 표시합니다.</span><span class="sxs-lookup"><span data-stu-id="ec5f1-104">This chapter displays the **tx_trace.h** file.</span></span>
