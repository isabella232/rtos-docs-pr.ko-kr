...
ms.locfileid: "116784141"
---
# <a name="appendix-a---azure-rtos-netx-services"></a>부록 A - Azure RTOS NetX 서비스

## <a name="address-resolution-protocol-arp"></a>ARP(주소 확인 프로토콜)  
...
## <a name="internet-protocol-ip"></a>IP(인터넷 프로토콜)  
...
## <a name="packet-management"></a>패킷 관리  
...
## <a name="reverse-address-resolution-protocol-rarp"></a>RARP(역주소 확인 프로토콜)  
