---
title: 부록 A - Azure RTOS NetX 서비스
description: Azure RTOS NetX 서비스에 대해 알아봅니다.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104810464"
---
# <a name="appendix-a---azure-rtos-netx-services"></a><span data-ttu-id="0320c-103">부록 A - Azure RTOS NetX 서비스</span><span class="sxs-lookup"><span data-stu-id="0320c-103">Appendix A - Azure RTOS NetX Services</span></span>

## <a name="address-resolution-protocol-arp"></a><span data-ttu-id="0320c-104">ARP(주소 확인 프로토콜)</span><span class="sxs-lookup"><span data-stu-id="0320c-104">Address Resolution Protocol (ARP)</span></span>  
...
## <a name="internet-control-message-protocol-icmp"></a><span data-ttu-id="0320c-105">ICMP(Internet Control Message Protocol)</span><span class="sxs-lookup"><span data-stu-id="0320c-105">Internet Control Message Protocol (ICMP)</span></span>  
...
## <a name="internet-group-management-protocol-igmp"></a><span data-ttu-id="0320c-106">IGMP(Internet Group Management Protocol)</span><span class="sxs-lookup"><span data-stu-id="0320c-106">Internet Group Management Protocol (IGMP)</span></span>  
...
## <a name="internet-protocol-ip"></a><span data-ttu-id="0320c-107">IP(인터넷 프로토콜)</span><span class="sxs-lookup"><span data-stu-id="0320c-107">Internet Protocol (IP)</span></span>  
...
## <a name="packet-management"></a><span data-ttu-id="0320c-108">패킷 관리</span><span class="sxs-lookup"><span data-stu-id="0320c-108">Packet Management</span></span>  
...
## <a name="reverse-address-resolution-protocol-rarp"></a><span data-ttu-id="0320c-109">RARP(역주소 확인 프로토콜)</span><span class="sxs-lookup"><span data-stu-id="0320c-109">Reverse Address Resolution Protocol (RARP)</span></span>  
...
## <a name="system-management"></a><span data-ttu-id="0320c-110">시스템 관리</span><span class="sxs-lookup"><span data-stu-id="0320c-110">System Management</span></span>  

```c
VOID nx_system_initialize(VOID);
```

## <a name="transmission-control-protocol-tcp"></a><span data-ttu-id="0320c-111">TCP(Transmission Control Protocol)</span><span class="sxs-lookup"><span data-stu-id="0320c-111">Transmission Control Protocol (TCP)</span></span>  
...
## <a name="user-datagram-protocol-udp"></a><span data-ttu-id="0320c-112">UDP(User Datagram Protocol)</span><span class="sxs-lookup"><span data-stu-id="0320c-112">User Datagram Protocol (UDP)</span></span>  
