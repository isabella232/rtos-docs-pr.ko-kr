---
title: 3장 - Azure RTOS NetX BSD Services
description: 이 장에는 아래에 나열된 모든 Azure RTOS NetX BSD 기본 서비스에 대한 설명이 알파벳 순서로 포함되어 있습니다.
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104810416"
---
# <a name="chapter-3---azure-rtos-netx-bsd-services"></a><span data-ttu-id="e5680-103">3장 - Azure RTOS NetX BSD Services</span><span class="sxs-lookup"><span data-stu-id="e5680-103">Chapter 3 - Azure RTOS NetX BSD Services</span></span>

<span data-ttu-id="e5680-104">이 장에는 아래에 나열된 모든 Azure RTOS NetX BSD 기본 서비스에 대한 설명이 알파벳 순서로 포함되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e5680-104">This chapter contains a description of all Azure RTOS NetX BSD basic services listed below in alphabetic order.</span></span>
