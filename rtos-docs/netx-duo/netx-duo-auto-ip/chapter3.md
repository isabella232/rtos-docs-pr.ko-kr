...
ms.locfileid: "116791196"
---
# <a name="chapter-3---description-of-azure-rtos-netx-duo-autoip-services"></a>3장 - Azure RTOS NetX Duo AutoIP 서비스 설명

이 장에는 모든 Azure RTOS NetX Duo AutoIP 서비스(아래에 나열됨)에 대한 설명이 알파벳 순서로 포함되어 있습니다.
...
- **NX_AUTO_IP_BAD_INTERFACE_INDEX**: (0xA02) 잘못된 네트워크 인터페이스 NX_PTR_ERROR(0x16) 잘못된 AutoIP 포인터
- NX_CALLER_ERROR: (0x11) 이 서비스의 호출자가 잘못되었습니다.
