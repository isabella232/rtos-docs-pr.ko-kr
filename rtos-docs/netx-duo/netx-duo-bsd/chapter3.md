...
ms.locfileid: "116791179"
---
# <a name="chapter-3---azure-rtos-netx-duo-bsd-services"></a>3장 - Azure RTOS NetX Duo BSD Services

이 장에는 모든 Azure RTOS NetX Duo BSD 기본 서비스(아래에 나열됨)에 대한 설명이 알파벳 순서로 포함되어 있습니다.
